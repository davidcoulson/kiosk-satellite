...
export function refreshNavigationText() {
  ...
  } else if ((currentPath.startsWith('esphome/') || currentPath.startsWith('device/') || currentPath.startsWith('homeassistant/') || currentPath.startsWith('screenaudio/') || currentPath.startsWith('screensaver/') || currentPath.startsWith('fleet/') || currentPath.startsWith('about/'))) {
